...
1. Исправить файл conf/server.xml (в директории томката). Добавить в него новый хост (или исправить дефолтный)
...
2. Добавить в корневую директорию Tomcat папку share_with_me
3. Перейти в директорию с проектом и собрать war файл с помощью команды
...
5. Развернуть дамб базы данных из db_dumb
6. Запустить сервер. Сервер распакует war файл и приложение будет доступно по ссылке в браузере:
```
